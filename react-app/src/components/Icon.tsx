/* ============================================================
   Icon — faithful port of js/icons.js (PSIcons + psIcon()).
   Same paths, same viewBox/stroke settings; renders as an inline
   <svg> React component instead of an HTML string.
   ============================================================ */

const PS_ICON_PATHS: Record<string, string> = {
